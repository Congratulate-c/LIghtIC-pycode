...
def screen_capture():
    ...
    img2 = pyautogui.screenshot(img_name2,region=(942, 215, 80 ,120))
...
#     if power<-25:
#         screen_capture()
#         x1,y1,power = read_img(path="valid_data_img.png")
#         residual_x = abs(x1)-abs(x)
#         residual_y = abs(y1)-abs(y)
#         if residual_x>300 or residual_y>300:
#             num = num+1
#             peak_x.append(x1)
#             peak_y.append(y1)
#             power_dbm.append(power)
